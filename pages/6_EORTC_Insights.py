...
st.set_page_config(
    page_title="EORTC Insights (unimplemented, EQ-5D as placeholder)",
    page_icon=logo_path,
    # layout="centered",
    # layout="wide",
    layout="centered",
...
st.warning("Arguably, EORTC would benefit more from per-question analysis compared to EQ-5D as it is more granular and more difficult for humans to process large numbers of cases. However, we do not have enough synthetic cases to show this capability for now.")
